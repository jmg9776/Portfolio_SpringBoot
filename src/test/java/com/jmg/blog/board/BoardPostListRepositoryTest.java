...
public class BoardPostListRepositoryTest {
    ...
    void boardPostListTest() {
        ...
        List<BoardPostResponse> interviewReviews = boardPostRepositoryCustomImpl.findBoardPostListByBoardName("면접 후기");
        logger.info(interviewReviews.toString());
        // 결과가 null이 아닌지 확인합니다.
        assertNotNull(interviewReviews, "'면접 후기'에 해당하는 게시글 목록이 null입니다.");

        // 모든 게시글 목록을 검색합니다.
        List<BoardPostResponse> allPosts = boardPostRepositoryCustomImpl.findBoardPostListByBoardName(null);
